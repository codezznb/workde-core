...
public class SimpleQuery {
    ...
    public <T extends BaseEntity> io.ebean.OrderBy<T> orderBy() {
    ...
    public <T extends BaseEntity> Expression whereExpression(Query<T> query) {
    ...
    private <T extends BaseEntity> Expression internalWhereExpression(Query<T> query) {
    ...
    private <T extends BaseEntity> Expression searchExpression(Query<T> query) {
